...
GitHub → Azure SQL DB → Data Lake → Databricks → Power BI
...
#📁 Project Files
ecommerce_data/*.csv: Raw + incremental datasets

adf_pipeline/*.json: ADF templates with Lookup, Copy, Notebook Activity

notebooks/*.dbc: Databricks notebooks for Silver & Gold transformations

sql/*.sql: Stored Procedures for tracking and casting

assets/architecture.png: Project architecture diagram
